    ...
    <div class="card">
        <div class="card-body">
            <div class="d-flex mb-4">
                <h5 class="card-title fw-semibold">Kelola Pengajar</h5>
                <a href="<?= base_url('pengajar/tambah') ?>" class="btn btn-sm btn-success ms-auto">Tambah</a>
            </div>
            <div class="card">
                            ...
                            foreach ($pengajar as $row) : ?>
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <a href="<?= base_url('pengajar/edit/' . $row->id_pengajar) ?>" class="btn btn-sm btn-warning">Edit</a>
                                        <button class="btn btn-sm btn-danger" data-bs-toggle="modal" data-bs-target="#hapus" data-bs-id="<?= $row->id_pengajar ?>" data-bs-data="<?= $row->nama ?>">hapus</button>
                                    </td>
                                </tr>
                            <?php endforeach ?>
                        </tbody>
...
<script>
    ...
    if (exampleModal) {
        exampleModal.addEventListener('show.bs.modal', event => {
            ...
            link.href = `<?= base_url('pengajar/hapus/') ?>${id}`
        })
    }
</script>