        ...
        <aside class="left-sidebar">
            ...
            <div>
                <div class="brand-logo d-flex align-items-center justify-content-between">
                    ...
                    <img src="<?= base_url('assets/img/logo.jpeg') ?>" width="100" alt="" />
                        <h1><b>Absensi QR</b></h1>
                    </a>
                ...
                <nav class="sidebar-nav scroll-sidebar" data-simplebar="">
                    <ul id="sidebarnav">
                        ...
                        <?php if ($this->session->userdata('role') == 1) : ?>
                            <li class="sidebar-item">
                                <a class="sidebar-link" href="<?= base_url('user/kelola') ?>" aria-expanded="false">
                                    <span>
                            ...
                            <li class="sidebar-item">
                                <a class="sidebar-link" href="<?= base_url('kursus/kelola') ?>" aria-expanded="false">
                                    <span>
                                        <i class="ti ti-article"></i>
                                    </span>
                            ...
                            <li class="sidebar-item">
                                <a class="sidebar-link" href="<?= base_url('siswa/kelola') ?>" aria-expanded="false">
                                    <span>
                                        <i class="ti ti-article"></i>
                                    </span>
                            ...
                            <li class="sidebar-item">
                                <a class="sidebar-link" href="<?= base_url('pengajar/kelola') ?>" aria-expanded="false">
                                    <span>
                                        <i class="ti ti-article"></i>
                                    </span>
                            ...
                            <li class="sidebar-item">
                                <a class="sidebar-link" href="<?= base_url('qr/kelola') ?>" aria-expanded="false">
                                    <span>
                                        <i class="ti ti-article"></i>
                                    </span>
                        ...
                        <?php else : ?>
                            <li class="sidebar-item">
                                <a class="sidebar-link" href="<?= base_url('absen') ?>" aria-expanded="false">
                                    <span>
                                        <i class="ti ti-article"></i>
                                    </span>
                        ...
                        <ul class="navbar-nav flex-row ms-auto align-items-center justify-content-end">
                            ...
                            <li class="nav-item dropdown">
                                <a class="nav-link nav-icon-hover" href="javascript:void(0)" id="drop2" data-bs-toggle="dropdown" aria-expanded="false">
                                    <img src="<?= base_url('assets/img/logo.jpeg') ?>" alt="" width="35" height="35" class="rounded-circle">
                                </a>
                                <div class="dropdown-menu dropdown-menu-end dropdown-menu-animate-up" aria-labelledby="drop2">
                                    <div class="message-body">
                                        <a href="<?= base_url('auth') ?>" class="btn btn-outline-info mx-3 mt-2 d-block">Profil</a>
